                        ...
                        <div className="form-group">
                            <label htmlFor="workerId">Work Range</label>
                                <div className="input-group mb-3">
                                    < select className="form-control" id="service" value={service} defaultValue={service} onChange={(e) => {setService(e.target.value)}} >
                        ...
                        <div className="col-sm-12 col-md-6 col-xl-6">
                                    <div className="form-group">
                                        ...
                                        <div className="input-group mb-3">
                                                ...
                                                <select className="form-control" id="service" value={district} defaultValue={district} onChange={(e) => {setDistrict(e.target.value)}}>
                                                    <option  value="" disabled></option>
