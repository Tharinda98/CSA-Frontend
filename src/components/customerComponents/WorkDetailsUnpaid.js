                                        ...
                                        <div className="card-block">
                                            <div className="row align-items-center justify-content-center">
                                                <div className="col-12">
                                                    ...
                                                    <div>
                                                        <p className="m-b-0">Description: {props.description}</p>
                                                    </div>
                                                    <div>
                                                        <p className="m-b-12">Started Date: {props.startDate}</p>
                                                    </div>
                                                    <div>
                                                        <p className="m-b-0">Finished Date: {props.finishDate}</p>
                                                    </div>
                                                    <div>
