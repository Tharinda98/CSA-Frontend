            ...
            <div className="navbar-wrapper">
                ...
                <div className="navbar-content scroll-div">
                    <ul className="nav pcoded-inner-navbar">
                        ...
                        <li className="nav-item">
                            <Link to="/Customer/Profile" className="nav-link "><span className="pcoded-micon"><i className="feather icon-user"></i></span><span className="pcoded-mtext">Profile</span></Link>
                        </li>
