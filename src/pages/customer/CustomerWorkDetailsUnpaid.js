...
const CustomerWorkDetailsUnpaid=()=>{
    ...
    if (customer.error) return <p>error</p>;
                        ...
                        <div className="pcoded-inner-content">
                            ...
                            <div className="row">
                                {works.data.customer_getMyFinishedWorks.map(work=>{
                                    if (!work.paid){
                                    return <WorkDetailsUnpaid Customer={customer.data.Customer_me} SP={work.booking.to.name} SP_ID={work.booking.to._id} startDate={work.starting_date} finishDate={work.finish_date}
                                    description={work.booking.description}
                                    appointment={work._id}
                                    cost={work.cost}/>
                                    }
                                })}
